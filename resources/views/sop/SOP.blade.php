            ...
            <tbody>
                <tr>
                    ...
                    <td class="align-middle">
                        <span>
                            <img src="../asset/img/Iconly/Light-Outline/Tick-Circle.svg" alt="">
                        </span>
                        <span class="ms-3">
                            <img src="../asset/img/Iconly/Light-Outline/Close-Circle.svg" alt="">
                        </span>
                    </td>
                </tr>
                <tr>
                    <td class="align-middle">Shafa Asyari</td>
                    <td class="align-middle">System Architect</td>
                    <td class="align-middle">CHRO</td>
                    <td class="align-middle">
                        <span>
                            <img src="../asset/img/Iconly/Light-Outline/Tick-Circle.svg" alt="">
                        </span>
