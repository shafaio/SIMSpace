<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" style="background-color: #05323C !important;">
    <div class="container ">
        ...
        <div class="collapse navbar-collapse px-5 justify-content-start" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('home/sop', 'home/sop/*') ? 'active' : '' }}" href="/home/sop" style="color: white !important; font-weight: 500;">SOP</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('home/document', 'home/document/*') ? 'active' : '' }} ms-3" href="/home/document" style="color: white !important; font-weight: 500;">Berkas</a>
                </li>
